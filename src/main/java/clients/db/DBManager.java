...
public class DBManager {
    ...
    public static final String COUNT_COUPON_BY_ID = "SELECT COUNT(*) FROM `coupons_project`.`coupons` WHERE `id` = ?;";
    ...
    public static final String COUNT_COMPANY_BY_NAME = "SELECT COUNT(*) FROM `coupons_project`.`companies` WHERE `name` = ?;";

    public static final String COUNT_COMPANY_BY_EMAIL = "SELECT COUNT(*) FROM `coupons_project`.`companies` WHERE `email` = ?;";
    ...
    public static final String UPDATE_CUSTOMER = "UPDATE `coupons_project`.`customer` SET `first_name` = ?, `last_name` = ?, `email` = ? `password` = ? WHERE (`id` = ?);";
    ...
    public static final String ADD_COUPON_TO_CUSTOMER = "INSERT INTO `coupons_project`.`customers_vs_coupons` " +
            "(`customer_id`, `coupon_id`) " +
            "VALUES (?,?);";
    public static final String GET_COUPONS_BY_CUSTOMER = "SELECT * FROM `coupons_project`.`customers_vs_coupons` WHERE `customer_id`=?;";
