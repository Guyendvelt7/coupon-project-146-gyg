...
//    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE);
    ...
    public static final String ADD_COMPANY =
            "INSERT INTO `coupons_project`.`companies` ( `name`, `email`, `password`)" +
                    " VALUES (?,?,?);";

    public static final String UPDATE_COMPANY =
            "UPDATE `coupons_project`.`companies` SET `email` = ?, `password` = ? " +
                    "WHERE (`id` = ?);";
    ...
    public static final String COUNT_BY_PASS_AND_EMAIL =
            "SELECT COUNT(*) FROM `coupons_project`.`companies` " +
    ...
    public static final String ADD_COUPON_TO_CUSTOMER =
            "INSERT INTO `coupons_project`.`customers_vs_coupons` " +
                    "(`customer_id`, `coupon_id`) VALUES (?,?);";
    public static final String GET_COUPONS_BY_CUSTOMER =
            "SELECT `coupon_id` FROM `coupons_project`.`customers_vs_coupons` WHERE `customer_id`=?;";

    public static final String GET_ALL_CUSTOMERS =
            "SELECT * FROM `coupons_project`.`customers`;";

    public static final String IS_CUSTOMER_EXISTS =
